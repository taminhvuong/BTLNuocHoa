...
<body>
                   ...
                   <span class="drop--down"> <a href="#">NƯỚC HOA</a></span>
                    <ul class="menu2">
                      <div class="menu2--dropdown">
                        <li class="menu2-list">
                            <a class="menu2a" href="trangcon1.aspx?idtype=1">Nước hoa Nam</a>
                         </li>
                         <li>
                             <a class="menu2a" href="trangcon1.aspx?idtype=2">Nước hoa Nữ</a>
                         </li>
                         <li>
                             <a class="menu2a" href="trangcon1.aspx?idtype=3">Nước hoa Unisex</a>
                         </li>
                      </div>
                    </ul>
                </li>
    ...
    <div class="title">
        <div>   <i class="fa-solid fa-house" style="color:darkgreen;"></i></div>
      <div class="a"><a href="trangchu.aspx"><h3 >Trang chủ</h3></a></div> 
       
        <div class="b"><a href="#"><h3 id="ddanh" runat="server"></h3></a></div>
     ...
     <div class="listproduct generate" id="listproduct-nam">
            <!-- Title --><div class="col l-2" style="background-color: #f5f5f5;">
                
                   </div>
                       <!-- List body -->
                       <div class="row listproduct-body"  id="productmale" runat="server" style="max-width:1200px">
